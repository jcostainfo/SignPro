...
public class PinCheck extends javax.swing.JFrame {
     ...
     * @param pincode
     */
    public PinCheck(String pincode) {
        initComponents();
        codeok = false;
        code = pincode;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/signpro/aux/secretCode100_100.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.code = Arrays.toString(jpw.getPassword());
        this.codeok = true;
    ...
    /**
     * @param codeok the codeok to set
     */
